function ADVR.onLoad()
    pickup.name = "Tainted Rose"
    pickup.desc =
    "Gain 2 heart containers and a protection heart, but if you dont kill an enemy within a long time limit you take some damage"
    pickup.weight = 30
    pickup.maxAmount = 1
    pickup.amountUses = -1
    pickup.price = 65
